...
class SCA_max:
    ...
    def plot_results(self):
        ...
        ax3.set_xticks(range(1,maxlen+1))
        ...
        ax4.set_xticks(range(1,maxlen+1))
        ...
        ax5.set_xticks(range(1,maxlen+1))
    ...
    #the same across the sample. 
        ...
        #                           print counter
            ...
            if transpose:
                ...
                Trasp = map(list, map(None, *distance_array))
